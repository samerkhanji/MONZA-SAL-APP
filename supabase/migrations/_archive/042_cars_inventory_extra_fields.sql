-- ============================================
-- MONZA CRM — Extra car inventory / customs fields + cars_display refresh
-- ============================================

ALTER TABLE public.cars
  ADD COLUMN IF NOT EXISTS trim text,
  ADD COLUMN IF NOT EXISTS specs text,
  ADD COLUMN IF NOT EXISTS bl_issue_date date,
  ADD COLUMN IF NOT EXISTS registration_date date,
  ADD COLUMN IF NOT EXISTS customs_notes text;

COMMENT ON COLUMN public.cars.trim IS 'Vehicle trim / variant label';
COMMENT ON COLUMN public.cars.specs IS 'Free-form specs text';
COMMENT ON COLUMN public.cars.bl_issue_date IS 'Bill of lading issue date';
COMMENT ON COLUMN public.cars.registration_date IS 'Registration date';
COMMENT ON COLUMN public.cars.customs_notes IS 'Customs-related notes (separate from general notes)';
